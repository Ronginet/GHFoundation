...
- (void)gh_updateButtonImageTitleStyle:(GHButtonImageTitleStyle)style padding:(CGFloat)padding {
    ...
    switch (style) {
        case GHButtonImageTitleStyleLeft: {
            if (padding != 0) {
        ...
        case GHButtonImageTitleStyleRight: {
            // 图片在右，文字在左
        ...
        case GHButtonImageTitleStyleTop: {
            // 图片在上，文字在下
        ...
        case GHButtonImageTitleStyleBottom: {
            // 图片在下，文字在上。
        ...
        case GHButtonImageTitleStyleCenterTop: {
        ...
        case GHButtonImageTitleStyleCenterBottom: {
        ...
        case GHButtonImageTitleStyleCenterUp: {
        ...
        case GHButtonImageTitleStyleCenterDown: {
        ...
        case GHButtonImageTitleStyleRightLeft: {
            // 图片在右，文字在左，距离按钮两边边距
        ...
        case GHButtonImageTitleStyleLeftRight: {
            // 图片在左，文字在右，距离按钮两边边距
            self.titleEdgeInsets = UIEdgeInsetsMake(0,
